...
namespace OfficeAssist.docPub.Model
{
    ...
    public class nhFont
    {
        ...
        [XmlAttribute]
        public int Animation; //WdAnimation Animation;// { get; set; }
        ...
        [XmlAttribute]
        public int Color; //WdColor Color;// { get; set; }
        [XmlAttribute]
        public int ColorIndex; //WdColorIndex ColorIndex;// { get; set; }
        [XmlAttribute]
        public int ColorIndexBi; //WdColorIndex ColorIndexBi;// { get; set; }
        // public int Creator;// { get; }
        [XmlAttribute]
        public int DiacriticColor; // WdColor DiacriticColor;// { get; set; }
        [XmlAttribute]
        ...
        [XmlAttribute]
        public int EmphasisMark ;//WdEmphasisMark EmphasisMark;// { get; set; }
        [XmlAttribute]
        ...
        [XmlAttribute]
        public int Underline; //WdUnderline Underline;// { get; set; }
        [XmlAttribute]
        public int UnderlineColor; //WdColor UnderlineColor;// { get; set; }
            ...
            foreach(int nItem in setMembers)
            {
                ...
                switch (euItem)
                {
                    ...
                    case euMembers.Animation:
                        wFnt.Animation = (Word.WdAnimation)Animation;
                        break;
                    ...
                    case euMembers.Color:
                        wFnt.Color = (Word.WdColor)Color;
                        break;

                    case euMembers.ColorIndex:
                        wFnt.ColorIndex = (Word.WdColorIndex)ColorIndex;
                        break;

                    case euMembers.ColorIndexBi:
                        wFnt.ColorIndexBi = (Word.WdColorIndex)ColorIndexBi;
                        break;

                    case euMembers.DiacriticColor:
                        wFnt.DiacriticColor = (Word.WdColor)DiacriticColor;
                        break;
                    ...
                    case euMembers.EmphasisMark:
                        wFnt.EmphasisMark = (Word.WdEmphasisMark)EmphasisMark;
                        break;
                    ...
                    case euMembers.Underline:
                        wFnt.Underline = (Word.WdUnderline)Underline;
                        break;

                    case euMembers.UnderlineColor:
                        wFnt.UnderlineColor = (Word.WdColor)UnderlineColor;
                        break;
        ...
        public int decodeFromString(Hashtable hashFeatures)
        {
            ...
            {
                Animation = (int)WdAnimation.wdAnimationNone;
            }
            ...
            {
                Color = (int)WdColor.wdColorAutomatic;
            }
            ...
            {
                ColorIndex = (int)WdColorIndex.wdAuto;
            }
            ...
            {
                ColorIndexBi = (int)WdColorIndex.wdAuto;
            }
            ...
            {
                DiacriticColor = (int)WdColor.wdColorAutomatic;
            }
            ...
            {
                EmphasisMark = (int)WdEmphasisMark.wdEmphasisMarkNone;
            }
            ...
            {
                Underline = (int)WdUnderline.wdUnderlineNone;
            }
            ...
            {
                UnderlineColor = (int)WdColor.wdColorAutomatic;
            }
        ...
        public void setDefault()
        {
            ...
            AllCaps = nInit;// 进行赋值
            Animation = nInit;//.wdAnimationNone;// 进行赋值
            Bold = nInit;// 进行赋值
            BoldBi = nInit;// 进行赋值

            Color = nInit;//.wdColorAutomatic;// 进行赋值
            ColorIndex = nInit;//.wdAuto;// 进行赋值
            ColorIndexBi = nInit;//.wdAuto;// 进行赋值
            // Creator = nInit;
            DiacriticColor = nInit;//.wdColorAutomatic;// 进行赋值
            DisableCharacterSpaceGrid = false;// 进行赋值
            DoubleStrikeThrough = nInit;// 进行赋值
            Emboss = nInit;
            EmphasisMark = nInit;//.wdEmphasisMarkNone;// 进行赋值
            ...
            Underline = nInit;//WdUnderline.wdUnderlineNone;// 进行赋值
            UnderlineColor = nInit; //.wdColorAutomatic;// 进行赋值
        ...
        public Boolean diff(Word.Font srcFont)
        {
            ...
            if (this.Animation != (int)srcFont.Animation)// 比较Animation
                return false;
            ...
            if (this.Color != (int)srcFont.Color)// 比较Color
                return false;

            if (this.ColorIndex != (int)srcFont.ColorIndex)// 比较ColorIndex
                return false;

            if (this.ColorIndexBi != (int)srcFont.ColorIndexBi)// 比较ColorIndexBi
                return false;

            if (this.DiacriticColor != (int)srcFont.DiacriticColor)// 比较DiacriticColor
                return false;
            ...
            if (this.EmphasisMark != (int)srcFont.EmphasisMark)// 比较EmphasisMark
                return false;
...
//                return false;
            ...
            if (this.Underline != (int)srcFont.Underline)// 比较Underline
                return false;

            if (this.UnderlineColor != (int)srcFont.UnderlineColor)// 比较UnderlineColor
                return false;
        ...
        public Boolean diff(ClassFont srcFont)
        {
            ...
            if (this.Animation != (int)srcFont.Animation) // 比较成员的异同，不同则返回
                return false;
            ...
            if (this.Color != (int)srcFont.Color) // 比较成员的异同，不同则返回
                return false;

            if (this.ColorIndex != (int)srcFont.ColorIndex) // 比较成员的异同，不同则返回
                return false;

            if (this.ColorIndexBi != (int)srcFont.ColorIndexBi) // 比较成员的异同，不同则返回
                return false;

            if (this.DiacriticColor != (int)srcFont.DiacriticColor) // 比较成员的异同，不同则返回
                return false;
            ...
            if (this.EmphasisMark != (int)srcFont.EmphasisMark) // 比较成员的异同，不同则返回
                return false;
...
//                return false;
            ...
            if (this.Underline != (int)srcFont.Underline) // 比较成员的异同，不同则返回
                return false;

            if (this.UnderlineColor != (int)srcFont.UnderlineColor) // 比较成员的异同，不同则返回
                return false;
        ...
        public void clone(Word.Font srcFont)
        {
            ...
            this.Animation = (int)srcFont.Animation;// 复制WORD.FONT的成员到本类成员
            ...
            this.Color = (int)srcFont.Color;// 复制WORD.FONT的成员到本类成员
            this.ColorIndex = (int)srcFont.ColorIndex;// 复制WORD.FONT的成员到本类成员
            this.ColorIndexBi = (int)srcFont.ColorIndexBi;// 复制WORD.FONT的成员到本类成员

            this.DiacriticColor = (int)srcFont.DiacriticColor;// 复制WORD.FONT的成员到本类成员
            ...
            this.EmphasisMark = (int)srcFont.EmphasisMark;// 复制WORD.FONT的成员到本类成员
            ...
            this.Underline = (int)srcFont.Underline;// 复制WORD.FONT的成员到本类成员
            this.UnderlineColor = (int)srcFont.UnderlineColor;// 复制WORD.FONT的成员到本类成员
        ...
        public void copy2(Word.Font dstFnt)
        {
            ...
            dstFnt.Animation = (Word.WdAnimation)this.Animation;// 复制本类成员到WORD.FONT类同名成员
            ...
            dstFnt.Color = (Word.WdColor)this.Color;// 复制本类成员到WORD.FONT类同名成员
            dstFnt.ColorIndex = (Word.WdColorIndex)this.ColorIndex;// 复制本类成员到WORD.FONT类同名成员
            dstFnt.ColorIndexBi = (Word.WdColorIndex)this.ColorIndexBi;// 复制本类成员到WORD.FONT类同名成员

            dstFnt.DiacriticColor = (Word.WdColor)this.DiacriticColor;// 复制本类成员到WORD.FONT类同名成员
            ...
            dstFnt.EmphasisMark = (Word.WdEmphasisMark)this.EmphasisMark;// 复制本类成员到WORD.FONT类同名成员
            ...
            dstFnt.Underline = (Word.WdUnderline)this.Underline;// 复制本类成员到WORD.FONT类同名成员
            dstFnt.UnderlineColor = (Word.WdColor)this.UnderlineColor;// 复制本类成员到WORD.FONT类同名成员
        ...
        public void clone(ClassFont srcFont)
        {
            ...
            this.Animation = (int)srcFont.Animation;// 复制ClassFont类同名成员到本类成员
            ...
            this.Color = (int)srcFont.Color;// 复制ClassFont类同名成员到本类成员
            this.ColorIndex = (int)srcFont.ColorIndex;// 复制ClassFont类同名成员到本类成员
            this.ColorIndexBi = (int)srcFont.ColorIndexBi;// 复制ClassFont类同名成员到本类成员

            this.DiacriticColor = (int)srcFont.DiacriticColor;// 复制ClassFont类同名成员到本类成员
            ...
            this.EmphasisMark = (int)srcFont.EmphasisMark;// 复制ClassFont类同名成员到本类成员
            ...
            this.Underline = (int)srcFont.Underline;// 复制ClassFont类同名成员到本类成员
            this.UnderlineColor = (int)srcFont.UnderlineColor;// 复制ClassFont类同名成员到本类成员

            if (srcFont.setMembers != null && this.setMembers != null)
            {
                this.setMembers.Clear();
                foreach (int nItem in srcFont.setMembers)
                {
        ...
        public void copy2(ClassFont dstFnt)
        {
            ...
            dstFnt.Animation = (Word.WdAnimation)this.Animation;// 复制本类成员到ClassFont类同名成员
            ...
            dstFnt.Color = (Word.WdColor)this.Color;// 复制本类成员到ClassFont类同名成员
            dstFnt.ColorIndex = (Word.WdColorIndex)this.ColorIndex;// 复制本类成员到ClassFont类同名成员
            dstFnt.ColorIndexBi = (Word.WdColorIndex)this.ColorIndexBi;// 复制本类成员到ClassFont类同名成员

            dstFnt.DiacriticColor = (Word.WdColor)this.DiacriticColor;// 复制本类成员到ClassFont类同名成员
            ...
            dstFnt.EmphasisMark = (Word.WdEmphasisMark)this.EmphasisMark;// 复制本类成员到ClassFont类同名成员
            ...
            dstFnt.Underline = (Word.WdUnderline)this.Underline;// 复制本类成员到ClassFont类同名成员
            dstFnt.UnderlineColor = (Word.WdColor)this.UnderlineColor;// 复制本类成员到ClassFont类同名成员

            if (dstFnt.setMembers != null && this.setMembers != null)
            {
                dstFnt.setMembers.Clear();
                foreach (int nItem in this.setMembers)
                {
                    dstFnt.setMembers.Add(nItem);
                }
            }
        ...
        ///------------
        public void clone(nhFont srcFont)
        {
            this.bEnable = srcFont.bEnable;
        ...
        // 复制本类到WORD.FONT类
        public void copy2(nhFont dstFnt)
        {
            dstFnt.bEnable = this.bEnable;
        ...
        public int formatString(RichTextBox rchTxt, String strPreBlanks)
        {
            ...
            if (setMembers.Contains((int)euMembers.NameFarEast))
            {
                strRet += "中文字体：" + NameFarEast + "\r\n";
            }

            if (setMembers.Contains((int)euMembers.NameAscii))
            {
                strRet += "西文字体：" + NameAscii + "\r\n";
            }

            if (setMembers.Contains((int)euMembers.Size))
            {
                String strSizeNum = "";

                if (Globals.ThisAddIn.m_hashFontSize2Name.Contains(Size))
                {
                    strSizeNum = (String)Globals.ThisAddIn.m_hashFontSize2Name[Size];
                    strRet += "字号:" + strSizeNum + Size.ToString("##.#") + "\r\n";
                }
                else
                {
                    strRet += "字号：" + Size.ToString("##.#") + "\r\n";
                }
            }
